<template>
    <div>
            ...
            <div class="addr-list-wrap">
              <div class="addr-list">
                <ul>
                  ...
                  <li class="addr-new" @click="isAdddressShow=true">
      ...
      <modal :mdShow="isAdddressShow" @close="isAdddressShow=false">
        <p slot="message">
          <label for="userName">用户：</label>
          <input type="text" v-model="userName" name="userName" id="userName">
          <br>
          <label for="streetName">地址：</label>
          <input type="text" v-model="streetName" name="streetName" id="streetName">
          <br>
          <label for="postCode">邮编：</label>
          <input type="text" v-model="postCode" name="postCode" id="postCode">
          <br>
          <label for="tel">电话：</label>
          <input type="text" v-model="tel" name="tel" id="tel">
          <br>
        </p>
        <div slot="btnGroup">
            <a class="btn btn--m" href="javascript:;" @click="addAddress">确认</a>
            <a class="btn btn--m btn--red" href="javascript:;" @click="isAdddressShow=false">取消</a>
        </div>
      </modal>
...
<script>
  ...
  export default{
      ...
      methods:{
          ...
          addAddress(){
            if(!this.userName||!this.postCode||!this.tel||!this.streetName){
              alert("请将信息填写完整！")
            }else{
